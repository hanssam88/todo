...
- [ ] `T-046` `하` `2026-04-08` 데이터블릭스 사용 가능 범위 확인
- [ ] `T-047` `하` `2026-04-15` Google Drive/Docs MCP 자체 호스팅 설정 — Google Cloud Console에서 OAuth 자격증명 생성 필요 (프로젝트 생성 권한 이슈 해결 필요). 패키지: @piotr-agier/google-drive-mcp. 참고: plans/lexical-puzzling-lollipop.md
