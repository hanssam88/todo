...
- [ ] `T-046` `하` `2026-04-09` 부킹닷컴 15% 고정 수수료율 레이트 채널 신설 내부 논의 → Addendum 작업 준비 — 출처: 야놀자x아고다 운영 weekly 2026-01-23
...
- [ ] `T-045` `하` `2026-04-09` 체크인/체크아웃 시간 이슈 데이터 Yoana에게 지속 축적 요청 후 개발팀에 자동화 방식 강하게 푸시 — 출처: Ctrip X YCGG bi weekly 2026-03-10
